...
@implementation NSAttributedString (TextRenderer)
                                       ...
                                       asFont:(UIFont *)font
{
  ...
  for(NSTextCheckingResult* resultGroup in results) {
    ...
    NSRange textRange = [resultGroup rangeAtIndex:1]; // outer group including markdown modifiers
    ...
    [attributedText replaceCharactersInRange:textRange withString:[string substringWithRange:plaintextRange]];
